...
\section{DSP boards}
The DSP boards are AMC cards that contain a FPGA, fast SDRAM (e.g.\ DDR3 or DDR4), four synchronized JESD204 high-speed DACs (AD9154, 16 channels in total) and one JESD204 ADC (ADC16DX370, 2 channels in total).
